                ...
                <div class="card-body-custom">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4">
                        ...
                        <div class="btn-group" role="group" aria-label="Time Period Filter">
                            <a href="{{ route('staff.logs', ['period' => 'today']) }}" class="btn btn-outline-primary {{ $period == 'today' ? 'active' : '' }}">Today</a>
                            <a href="{{ route('staff.logs', ['period' => 'week']) }}" class="btn btn-outline-primary {{ $period == 'week' ? 'active' : '' }}">This Week</a>
                            <a href="{{ route('staff.logs', ['period' => 'month']) }}" class="btn btn-outline-primary {{ $period == 'month' ? 'active' : '' }}">This Month</a>
                            <a href="{{ route('staff.logs', ['period' => 'all']) }}" class="btn btn-outline-primary {{ $period == 'all' ? 'active' : '' }}">All Time</a>
                        </div>
                    </div>
                            ...
                            <div class="stat-card">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <h3 class="stat-value text-success">+{{ number_format($totalReturned) }}</h3>
