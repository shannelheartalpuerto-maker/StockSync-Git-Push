    ...
    <div class="content-card mb-4">
        <div class="card-header-custom d-flex justify-content-between align-items-center">
            ...
            <div class="btn-group" role="group" aria-label="Time Period Filter">
                <a href="{{ route('admin.stock_logs.index', ['period' => 'today']) }}" class="btn btn-sm btn-outline-primary {{ $period == 'today' ? 'active' : '' }}">Today</a>
                <a href="{{ route('admin.stock_logs.index', ['period' => 'week']) }}" class="btn btn-sm btn-outline-primary {{ $period == 'week' ? 'active' : '' }}">This Week</a>
                <a href="{{ route('admin.stock_logs.index', ['period' => 'month']) }}" class="btn btn-sm btn-outline-primary {{ $period == 'month' ? 'active' : '' }}">This Month</a>
                <a href="{{ route('admin.stock_logs.index', ['period' => 'all']) }}" class="btn btn-sm btn-outline-primary {{ $period == 'all' ? 'active' : '' }}">All Time</a>
            </div>
        </div>
                    ...
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h3 class="stat-value text-success">+{{ number_format($totalStockIn) }}</h3>
                    ...
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h3 class="stat-value text-info">+{{ number_format($totalReturned) }}</h3>
                    ...
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h3 class="stat-value text-primary">-{{ number_format($totalStockOut) }}</h3>
                    ...
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <h3 class="stat-value text-danger">{{ number_format($totalDamaged) }}</h3>
