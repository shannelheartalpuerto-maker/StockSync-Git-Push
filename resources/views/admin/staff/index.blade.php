...
<div class="container-fluid px-4 admin-dashboard-container animate-fade-up">
    ...
    <div class="dashboard-header">
        <h2 class="dashboard-title"><i class="fa-solid fa-users me-3 text-primary"></i>Staff Management</h2>
        <p class="dashboard-subtitle">Manage staff accounts and access permissions.</p>
    </div>

    <div class="content-card mb-4">
        <div class="card-header-custom">
            <h5 class="card-title-custom mb-0"><i class="fa-solid fa-user-group me-2"></i>Manage Staff</h5>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="p-3 bg-light rounded-3 h-100 border">
                        <h5 class="mb-3 fw-bold text-dark"><i class="fa-solid fa-user-plus me-2 text-success"></i>Add New Staff</h5>
                        <form method="POST" action="{{ route('admin.staff.store') }}">
                            ...
                            <button type="submit" class="btn btn-primary w-100">
                                <i class="fa-solid fa-plus me-2"></i>Create Staff Account
                            </button>
                        </form>
                    </div>
                </div>
                ...
                <!-- Staff List Section -->
                <div class="col-md-8">
                    <h5 class="mb-3 fw-bold text-dark"><i class="fa-solid fa-list me-2 text-primary"></i>Staff List</h5>
                            ...
                            <tbody>
                                            ...
                                            <div class="dropdown-menu p-2" style="min-width: auto;">
                                                <div class="d-flex gap-2">
                                                    @if($member->status == 'active')
                                                        <button type="button" class="btn btn-warning btn-sm text-white" data-bs-toggle="modal" data-bs-target="#suspendStaffModal{{ $member->id }}">
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteStaffModal{{ $member->id }}">
                                ...
                                <tr>
                                    <td colspan="4" class="text-center py-5 text-muted">
                                        ...
                                        <p class="mb-0">No staff accounts found.</p>
                                    </td>
                                </tr>
                                @endif
                            </tbody>
...
@foreach($staff as $member)
    ...
    <div class="modal fade" id="suspendStaffModal{{ $member->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-warning text-dark">
                    <h5 class="modal-title fw-bold"><i class="fa-solid fa-user-lock me-2"></i>Suspend Staff Account</h5>
                ...
                <div class="modal-body p-4 text-center">
                    ...
                    <p class="text-muted mb-0">
                        Do you really want to suspend <strong>{{ $member->name }}</strong>?<br>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title fw-bold"><i class="fa-solid fa-trash-can me-2"></i>Delete Staff Account</h5>
                ...
                <div class="modal-body p-4 text-center">
                    ...
                    <h5 class="fw-bold mb-2">Are you sure?</h5>
                    <p class="text-muted mb-0">
                        Do you really want to delete <strong>{{ $member->name }}</strong>?<br>
